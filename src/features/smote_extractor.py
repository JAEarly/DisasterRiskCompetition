...
class SmoteExtractor(FeatureExtractor, ABC):
    ...
    def __init__(self, base_feature_extractor: FeatureExtractor, smote_type: SmoteType = SmoteType.Normal, save_dir="./models/features/", root_dir="./data/processed/"):
        super().__init__(base_feature_extractor.name + "_" + smote_type_to_name(smote_type), save_dir=save_dir, root_dir=root_dir)
